        ...
        <form method="post" action="/dashboard/mahasiswas/{{$mahasiswa->id}}" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <select class="form-select" name="prodi">
                    ...
                    <option value="Teknik Sipil" {{ old('prodi', $mahasiswa->prodi)=='Teknik Sipil' ? 'selected' : '' }}>Teknik Sipil</option>
            ...
            <div class="mb-3">
                ...
                <select class="form-select" name="kelas">
                    ...
                    <option value="Reguler A" {{ old('kelas', $mahasiswa->kelas)=='Reguler A' ? 'selected' : '' }}>Reguler A</option>
                    <option value="Reguler B" {{ old('kelas', $mahasiswa->kelas)=='Reguler B' ? 'selected' : '' }}>Reguler B</option>
                    <option value="Reguler C" {{ old('kelas', $mahasiswa->kelas)=='Reguler C' ? 'selected' : '' }}>Reguler C</option>
                    <option value="Reguler D" {{ old('kelas', $mahasiswa->kelas)=='Reguler D' ? 'selected' : '' }}>Reguler D</option>
                    <option value="Non Reguler" {{ old('kelas', $mahasiswa->kelas)=='Non Reguler' ? 'selected' : '' }}>Non Reguler</option>
                </select>
            </div>
            <div class="mb-3">
                ...
                <select class="form-select" name="status_aktif">
                    ...
                    <option value="Lulus" {{ old('status_aktif', $mahasiswa->status_aktif)=='Lulus' ? 'selected' : '' }}>Lulus</option>
                </select>
            </div>
