        ...
        <form method="post" action="/dashboard/prestasis/{{$prestasi->id}}" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="date" class="form-control @error('waktu') is-invalid @enderror" id="waktu"
                    name="waktu" value="{{ old('waktu', $prestasi->waktu) }}" required autocomplete="off">
                @error('waktu')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                <select class="form-select" name="tingkat">
                    ...
                    <option value="Internasional"{{ old('tingkat', $prestasi->tingkat)=='Nasional' ? 'selected' : '' }}>Internasional</option>
                </select>
            </div>
            <div class="mb-3">
